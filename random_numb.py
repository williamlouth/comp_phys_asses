...
def random_numb_asses(rand_number = 10**5):
    ...
    pl.savefig("uniform01",bbox_inches = 'tight',dpi = 250)
    ...
    pl.savefig("1sin2x",bbox_inches = 'tight',dpi = 250)
    ...
    pl.savefig("2pisin2x",bbox_inches = 'tight',dpi = 250)
